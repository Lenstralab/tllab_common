...
class IJTiffWriter():
    """ Class for writing ImageJ big tiff files using good compression and multiprocessing to compress quickly
        ...
        file:     filename of the new tiff file or list of filenames
        shape:    shape (CZT) of the data to be written or list of shapes
        frame:    2D numpy array with data

        optional:
        dtype:    coerce to datatype before saving, (u)int8, (u)int16, float32 or list of dtypes
        colormap: colormap name from colorcet package or list of colormaps
    ...
    @dispatch(strtype, object, Number, Number, Number)
